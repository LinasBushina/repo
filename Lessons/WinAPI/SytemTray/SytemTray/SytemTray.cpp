                     ...
                     _In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_SYTEMTRAY, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_SYTEMTRAY));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_SYTEMTRAY));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_SYTEMTRAY);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_RBUTTONDOWN:
	{
		...
		RegSetValueEx(rKey, L"MyRegValue", 0, REG_SZ, (const BYTE *)new_value, new_valueSize);
		RegCloseKey(rKey);
